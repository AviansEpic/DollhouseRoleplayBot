-- this is an old project, it barely works now

local settings = {
  ["message"] = "bytecode # 3123 was here!!"
}
...
queueTp("loadstring(game:HttpGet('https://raw.githubusercontent.com/AviansEpic/DollhouseRoleplayBot/main/main.lua'))()")
